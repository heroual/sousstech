        ...
        >
          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                <div key={index} className="flex items-center">
                  <div className="bg-gradient-to-r from-cyan-400 to-blue-400 w-8 h-8 rounded-full flex items-center justify-center mr-4 text-gray-900 font-bold">
                    {item.step}
                  </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/contact"
                className="inline-flex items-center bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-8 py-4 rounded-full font-bold text-lg hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-cyan-500/25 group"
              >
                Demander un Devis
          ...
          <div className="grid gap-4">
            ...
            >
              ...
              <div>
                ...
                <p className="text-blue-200 text-sm">Réponse en 5 minutes</p>
              </div>
            </motion.a>
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={index} className="text-blue-200 text-sm font-medium">
                {benefit}
              </div>
            ))}
          </div>
